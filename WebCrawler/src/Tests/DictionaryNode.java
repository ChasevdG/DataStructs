 ...
 */
/*
 * Has pointers to next node and previous node
 * Stores a character and two booleans
 * One boolean signifies end of a word
 * IsVisited is used for traversing in iterator
 */
public class DictionaryNode {
    ...
    {
    	if(parentNode!=null){
    	DictionaryNode n = getParent();
    	n.pointers.remove(this);}
